...
import { QRBackground, QRCode } from "../../static";
    ...
    <Page className="member-page">
      ...
      <Box>
        <Box className="qr-wrapper">
          <Box className="qr-wrapper-block">
            <Text className="qr-name">{user.name}</Text>
            <img className="qr-background" src={QRBackground} />

            <div className="qr-rank-block">
              ...
              <Box className="flex reward-block_point">
                ...
                <Text size="xLarge" style={{ marginLeft: "8px" }}>
                  0
                </Text>
              </Box>
            </div>
            <img className="qr-img" src={QRCode} />
            <Text className="qr-des">
